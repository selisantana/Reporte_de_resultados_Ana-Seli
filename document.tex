...
\begin{document}
	...
	Una de las etapas importantes para la producción de estos biocombustibles es el pretratamiento. Se pretende configurar los pretratamientos para producir mayor cantidad de biocombustible, más información en \cite{zuliani2021biorefinery}. En este documento se presentan los resultados obtenidos en el proceso de producción de bioetanol a partir de biomasa lignocelulósica (bagazo de caña), evaluando diferentes métodos de pretratamiento (biológico y alcalino), así como las comparativas entre los costos-producción, resultado de cada uno de los procesos, utilizando diferentes valores y pretratamientos.
...
Como parte del proceso, se implementará hidrólisis y fermentación simultáneas (SSF), siguiendo la metodología propuesta por \cite{Arturo2022evaluacion}, con el propósito de acortar los tiempos de producción y reducir gastos operativos. El análisis comparará no solo la eficiencia en la conversión a etanol, sino también el impacto económico y energético de cada alternativa de pretratamiento.
El objetivo es obtener la configuración que proporcione la mayor producción de bioetanol de segunda generación (2G) en base a las variables modificadas, el costo de producción y el consumo energético.
...
% Para cada anexo:
\stepcounter{anexo}
\subsection*{A.\theanexo\ Marco conceptual}
\subsubsection*{A.\theanexo\ Bioetanol de segunda generación}
\addcontentsline{toc}{subsection}{A.\theanexo\ Bioetanol de segunda generación}
	...
	\subsection*{A.\theanexo\ Definición de conceptos}
		\addcontentsline{toc}{subsection}{A.\theanexo\ Bioetanol de segunda generación}
