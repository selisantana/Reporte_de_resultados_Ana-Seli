...
\begin{document}
	...
	Analizar experimentalmente los efectos del tamaño de partícula de biomasa, temperatura y tiempo de procesamiento en dos tipos de pretratamiento de bagazo de caña de azúcar, con configuración de producción de hidrólisis y fermentación simultáneas, para producir bioetanol de segunda generación. \newline \newline
	
	{\large Objetivos específicos}
	
	\begin{itemize}
		\item Diseñar los experimentos para analizar los tres factores considerados, con diferentes niveles.
		\item Acondicionar e instrumentar un reactor tipo batch para llevar a cabo separadamente las etapas de pretratamiento SSF.
		\item Diseñar e implementar un control de temperatura para el reactor operando en las etapas de pretratamiento y SSF.
		\item Aplicar experimentalmente dos tipos de pretratamiento, el primero es biológico con humus de lombriz y el segundo es alcalino usando hidroxido de sodio. \item Producir bioetanol de segunda generación por medio de una configuración SSF usando el bagazo pretatado con las condiciones definidas por el diseño de experimentos.
	...
	\begin{itemize}
		...
		\item 
		Desarrollo un prototipo de laboratorio para la producción de bioetanol a partir de bagazo de caña.
		
		\item 
		DisConjunto de experimentos con el propósito de realizar configuraciones en pretratamientos para la producción de bioetanol. 
...
En la Figura \ref{biologico2} se puede observar un diagrama que plantea a detalle los factores y niveles que se modifican en cada prueba. El factor A del tamaño de partícula y en factor B la temperatura dentro del reactor tipo Batch de para las experimentaciones.
...
A continuación se presentan los resultados de las pruebas experimentales después de realizar la etapa de hidrólisis y fermentación en conjunto. Los datos a considerar son la cantidad de alcohol obtenida, así como el consumo energético en las etapas en conjunto.
   ...
   Posteriormente según el proceso de producción de bioetanol se realiza una hidrólisis y fermentación en conjunto, para cada uno de los pretratamientos realizados en la Tabla \ref{ssf Pretratamiento Biológico} menciona las 6 pruebas realizadas a tres temperaturas diferentes con dos tamaños de partícula. Durante las pruebas se registraron la energía consumida, por lo que en la columna cuatro menciona el dato en kwh.
 	...
 	\begin{table}[H]
 		...
 		\begin{tabular}{|c|c|c|c|c|}
 			\hline
 			Prueba & Temperatura  & Tamaño de bagazo & Consumo energético  & Cantidad \\ 
 			&(°c)&&(kwh)&de alcohol (\%)\\ \hline
 			1 & \multirow{2}{*}{45} & TNUB & 2.8 & 11.5 \\ \cline{1-1} \cline{3-5}
 			2 &  & 1 cm & 2.7  & 14 \\ \hline
 			3 & \multirow{2}{*}{40} & TNUB &  2.56 & 11 \\ \cline{1-1} \cline{3-5}
 			4 &  & 1 cm & 1.74  & 11 \\  \hline
 			5 & \multirow{2}{*}{30} & TNUB & 2.7 & 11 \\ \cline{1-1} \cline{3-5}
 	...
 	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{table}[H]
			...
			\begin{tabular}{|c|c|c|c|c|c|}
				...
				5 & \multirow{4}{*}{90} & \multirow{2}{*}{TNUB} & 5400 & 1.87 & 12 \\  \cline{1-1} \cline{4-6}
				6 &  &  & 7870 & 1.88 & 13 \\ \cline{1-1} \cline{3-6}
				7 &  & \multirow{2}{*}{1 cm} & 5400 & 2.63 & 13 \\ \cline{1-1} \cline{4-6}
				8 &  &  & 7870 & 2.88 & 11 \\ \hline
				9 &\multirow{2}{*}{80 } & TNUB & 5400 & 1.84 & 13 \\ \cline{1-1} \cline{3-6}
...
Dado que se regusto el consumo energético a continuación se presentan los precios en \$ USD para cada una de las pruebas experimentales realizadas para el pretratamiento biológico.
	...
	\setlength{\tabcolsep}{2.5pt}
		\begin{tabular}{|c|c|c|c|}
			...
			\textbf{del pretratamiento} &	\textbf{ de bagazo}  & 	\textbf{(kwh) }& 	\textbf{(\$ USD)} \\ \hline
       \multirow{2}{*}{95} & TNUB & 4.55 & 0.294 \\ \cline{2-4}
	 & 1cm & 3.81 & 0.246 \\ \hline
\multirow{2}{*}{90} & TNUB & 2.77 & 0.179 \\ \cline{2-4}
	 & 1cm & 2.81 & 0.181  \\ \hline
\multirow{2}{*}{80}	 & TNUB & 0.75 & 0.048  \\ \cline{2-4}
	 & 1cm & 1.11 & 0.071  \\ 	\hline		
		\end{tabular}
...
De los resultados obtenidos se desprende que el consumo energético promedio requerido para el pretratamiento biológico asciende a 2.43 kWh, lo que representa un costo promedio de \$0.157 USD (Cero punto ciento cincuenta y siete dólares) por prueba experimental. Los valores de consumo energético reportados en este estudio fueron obtenidos de fuentes oficiales de la Comisión Federal de Electricidad (CFE), correspondientes a las tarifas para el municipio de Cuernavaca, Morelos.
	...
	\begin{table}[H]
		...
		\setlength{\tabcolsep}{2.5pt}
			\begin{tabular}{|c|c|c|c|c|}
				\hline
				\textbf{Temperatura} & \textbf{Tamaño } & \textbf{Tiempo} & \textbf{Energía consumida} & \textbf{Costos } \\ 
				\textbf{del pretratamiento} &	\textbf{ de bagazo}  &	\textbf{ (s)} & 	\textbf{(kwh) }& 	\textbf{(\$ USD)} \\ \hline
				\multirow{5}{*}{95} & \multirow{3}{*}{TNUB} & 5400 & 0.66 & 0.88968  \\  \cline{3-5}
				&  & 7870 & 0.81 & 1.09188  \\ \cline{2-5}
				& \multirow{3}{*}{1 cm} & 5400 & 0.74 & 0.04786  \\  \cline{3-5}
				&  & 7870 & 0.86 & 0.055  \\  \hline
				\multirow{5}{*}{90} & \multirow{3}{*}{TNUB} & 5400 & 0.66 & 0.88968  \\  \cline{3-5}
				&  & 7870 & 0.7  & 0.9436  \\ 	\cline{2-5}
				& \multirow{2}{*}{1 cm} & 5400 & 0.6 & 0.0388   \\  \cline{3-5}
				&  & 7870 & 0.74 & 0.047865\\   \hline
				\multirow{2}{*}{80}	 & TNUB & 5400 & 0.67 & 0.90316  \\  \cline{2-5}
	...
	En la producción de bioetanol de segunda generación se tomaron los costos en la producción, en la Tabla \ref{hidrolisis costos} se consideraron los insumos necesarios para esta etapa, desde el costo por prueba hasta el costo del envió. Tomando en cuenta los materiales mencionados, el costo total por prueba es de \$13.53 USD.
		...
		\end{table}
			...
			Adicionando al costo de 
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\textbf{ Consumo energético en hidrólisis y fermentación con bagazo de caña pretratado Biológicamente }
	
	En los pruebas experimentales con hidrólisis y fermentación utilizando bagazo pretratado con humus de lombriz se tomaron lecturas de consumo energético, en la Tabla \ref{pruebbio}.
	...
	{\fontsize{9}{10.8}\selectfont % Ajusta el tamaño de letra a 12pt
		\begin{tabular}{|c|c|c|c|}
			...
			\textbf{del} &	\textbf{ de bagazo}   & 	\textbf{consumida  }& 	\textbf{ total} \\ 
			\textbf{pretratamiento}  &    & \textbf{(kwh)} & \textbf{(\$)} \\ \hline
			\multirow{2}{*}{45}& TNUB & 2.8 & 0.18 \\  \cline{2-4}
			& 1 cm & 2.7 & 0.17  \\ \hline 
			\multirow{2}{*}{40} & TNUB & 2.56 & 0.16  \\ \cline{2-4}
			& 1 cm & 1.74 & 0.11  \\ \hline
			\multirow{2}{*}{30}	& TNUB & 2.7 & 0.17  \\ \cline{2-4}
			& 1 cm & 3.01 & 0.19  \\ \hline
...
\end{table}
	...
	\begin{table}[H]
		...
		{\fontsize{9}{10.8}\selectfont
			\begin{tabular}{|l|l|l|l|l|}
				...
				\textbf{del} &	\textbf{ de bagazo}  &	\textbf{ (s)} & 	\textbf{consumida  }& 	\textbf{(\$ USD)} \\ 
				\textbf{pretratamiento}  &  &  & \textbf{(kwh)} &  \\ \hline
				\multirow{5}{*}{95} &\multirow{2}{*}{ TNUB} & 5400 & 1.95 & 0.12 \\ \cline{3-5}
				&  & 7870& 2.74 & 0.17  \\ \cline{2-5}
				& \multirow{2}{*}{ 1 cm}& 5400  & 1.41 & 0.09  \\ \cline{3-5}
				&   & 7870 & 2.78 & 0.17  \\ \hline
				\multirow{5}{*}{90}	 & \multirow{2}{*}{TNUB} & 5400 & 1.87 & 0.12 \\ \cline{3-5}
				 &  & 7870 & 1.88 & 0.121 \\ \cline{2-5}
				 & \multirow{2}{*}{1 cm} & 5400 & 2.63 & 0.17 \\ \cline{3-5}
				& & 7870 & 2.88 & 0.18  \\ \hline
				\multirow{2}{*}{80}	 & TNUB & 5400 & 1.84 &0.11   \\ \cline{2-5}
				 & 1 cm & 7870 & 2.58 & 0.16 \\ \hline
		\end{tabular}}
	...
	\begin{table}[H]
		...
		\resizebox{16cm}{!} {
			\begin{tabular}{|c|c|c|c|c|}
				\hline
				Prueba & Total de costo por & Gasto  & Gasto total & Producción de \\ 
				~ &  pretratamiento &  energético promedio (\$ USD) &   (\$ USD) &  alcohol obtenido (\%)  \\ \hline
	...
	\end{table}
			...
			\begin{figure} [H]
				\centering
				\includegraphics[width=18cm, height=7cm]{imagenes/biologico_9}
				\caption{Producción de bioetanol con pretratamiento biologico}
				\label{grafica biolo}
			\end{figure}
			...
			Para el pretratamiento alcalino podemos observar que para un TNUB no hay cambios modificando la temperatura, sin embargo para 1 cm hay cambios significantes con una temperatura de 90°c
				...
				\begin{figure} [H]
				\centering
				\includegraphics[width=18cm, height=7cm]{imagenes/biologico_10}
				\caption{Producción de bioetanol con pretratamiento alcalino}
				\label{grafica biolo10}
			\end{figure}
						...
						\begin{figure} [H]
				\centering
				\includegraphics[width=7cm, height=7cm]{imagenes/grafico_alcalino}
				\caption{Producción de bioetanol con pretratamiento biologico}
				\label{grafica}
			\end{figure}
