...
\begin{document}
	...
	\section{Planteamiento del problema}
		...
		Este proyecto se basa en la producción de bioetanol de segunda generación la cual tiene como base la producción de biocombustible a partir de basura orgánica, el problema principal que aborda es la utilización de diferentes pretratamientos que ayuden a romper la barrera de la lignina y así poder producir mayor bioetanol. Estas técnicas de pretratamiento buscan modificar y controlar las variables para obtener la configuración que de mejores resultados.
	...
	\begin{itemize}
		...
		\item 	Diseñar un sistema de control para las configuraciones de producción de bioetanol de segunda generación.
...
\begin{table}[H]
	\centering
	\caption{Cargas y temperaturas para pruebas experimentales para pretratamiento biológico con un tiempo de 15 días}
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{| c | c | c | c | c | c | c | c |}
			...
			\hline
			\multirow{6}{*}{Bagazo de caña} & \multirow{6}{*}{Carga de 3\%}  & \multirow{6}{*}{Biológico} &\multirow{6}{*}{5\% p/v}  &\multirow{6}{*}{6 l}  & \multirow{3}{*}{Varios tamaños} & \textcolor{blue}{30°C} \\ \cline{7-7}
			& & & & & & \textcolor{blue}{40°C} \\ \cline{7-7}
			& & & & & & \textcolor{blue}{45°C} \\ \cline{7-7}
			\cline{6-7}
			&  &  &  &  & \multirow{3}{*}{1 cm}& 30°C \\ \cline{7-7}
			& & & & & & 40°C \\ \cline{7-7}
			& & & & & & 45°C \\ \cline{7-7}
			\hline
		\end{tabular}
	...
	\resizebox{\textwidth}{!}{   % Ajusta al ancho del documento (textwidth)
		\begin{tabular}{| c | c | c | c | c | c|c|c|}
			...
			\textbf{Biomasa}  & \textbf{Carga de} & \textbf{Pretratamiento} & \textbf{Carga de } & \textbf{Volumen} && \textbf{Tamaño} & \textbf{Temperatura} \\  
				& \textbf{ biomasa}& &\textbf{hidróxido de sodio }& &\textbf{Tiempo}& &  \\
			
			\hline
			\multirow{6}{*}{Bagazo de caña}& \multirow{6}{*}{4\%}& \multirow{6}{*}{Alcalino}& \multirow{6}{*}{2\% p/v } & \multirow{6}{*}{6 L}&&\multirow{3}{*}{Varios tamaños} & \textcolor{blue}{80°C}  \\
			  &   &  &  &   & 5400 && \textcolor{blue}{90°C}   \\  
			 &  & & & & && \textcolor{blue}{95°C}\\ 
		
				\cline{6-8}
			
			&   & & & & && 80°C\\
			  &   &  & & &7870 &\multirow{2}{*}{ 1 cm} & 90°C  \\ 
			 & &  & & & && 95°C \\ 
			\hline
		\end{tabular}
	} % Cierre de \resizebox
	...
	\end{equation}
		...
		\begin{table}[H]
			...
			\resizebox{16cm}{!} {
				\begin{tabular}{|c|c|c|c|c|c|c|c|c|  }
					\hline
					\textbf{Num} & \textbf{Tamaño } & \textbf{Cantidad } & \textbf{Volumen} & \textbf{Humus} & \textbf{Tiempo} & \textbf{Tem-} & \textbf{Tiempo} & \textbf{RPM} \\
					...
					\hline
					1 & \multirow{6}{*}{TNUB} & \multirow{12}{*}{180 g} & \multirow{12}{*}{6 L}  & \multirow{12}{*}{300 g }& \multirow{12}{*}{2}  & 45 & \multirow{12}{*}{10 s}  & \multirow{12}{*}{333 RPM}   \\
					&  & &  & &  &   &  &  \\	\cline{1-1}\cline{7-7}
					...
					3 &  &  &  &  & & 30 &  & \\
					&  & &  & &  &   &  &  \\	\cline{1-1}\cline{2-2}\cline{7-7}
					
					
					
					4 & \multirow{6}{*}{1 cm} &  &  &  &  & 45 &  &    \\
					& & &  & &  &   &  &  \\	\cline{1-1}\cline{7-7}
		...
		De la misma forma cada pretratamiento sera realizado con 3 factores donde el primer factor es de 2 niveles, es decir el tamaño de bagazo de caña, para el segundo factor es la temperatura donde tiene tres niveles y por ultimo el factor c o el tercero factor que tiene 3 niveles, en total se realizaran 12 experimentaciones para el pretratamiento alcalino  pretratamiento como se muestra en la Tabla \ref{datos experimentales}. Esta presenta en la segunda columna el factor A, es decir el tamaño de bagazo a considerar en la experimentación; en la tercera columna se muestra el volumen a utilizar, para este caso es 6 l , esto se tomo dado que el volumen máximo del reactor son 10 l, sin embargo  la resistencia que se encuentra alrededor del reactor se encuentran en una altura de un volumen de 6 l, para el caso de la cuarta columna se tomo el porcentaje de hidróxido de sodio que se utiliza para el volumen especificado.
			...
			\begin{table}[H]
			\centering
			\caption{Condiciones de operación del reactor para la producción de bioetanol 2G con pretratamiento alcalino.}
			\label{datos experimentales}
			\resizebox{16cm}{!} {
				\begin{tabular}{|c|c|c|c|c|c|c|c|c|  }
					\hline
					\textbf{Num} & \textbf{Tamaño } & \textbf{Cantidad } & \textbf{Volumen} & \textbf{Humus} & \textbf{Tiempo} & \textbf{Tem-} & \textbf{Tiempo} & \textbf{RPM} \\
					& \textbf{ de bagazo} & \textbf{ bagazo} & & \textbf{de lombriz} & \textbf{(S)} & \textbf{peratura}&  \textbf{ $/$encendido}&   \\
					
					& &  \textbf{ de caña} & &  &  &  &\textbf{ apagado} &  \\
					
					
					\hline
					1 & \multirow{6}{*}{TNUB} & \multirow{12}{*}{240 g} & \multirow{12}{*}{6 L}  & \multirow{12}{*}{120 g }& \multirow{3}{*}{5400}  & 95 & \multirow{12}{*}{10 s}  & \multirow{12}{*}{333 RPM}   \\
					&  & &  & &  &   &  &  \\	\cline{1-1}\cline{7-7}
					...
					3 &  &  &  &  &\multirow{3}{*}{7870} & 80 &  & \\
					&  & &  & &  &   &  &  \\	\cline{1-1}\cline{2-2}\cline{6-6}\cline{7-7}
					
					
					
					4 & \multirow{6}{*}{1 cm} &  &  &  &  \multirow{3}{*}{5400} & 95 &  &    \\
					& & &  & &  &   &  &  \\	\cline{1-1}\cline{7-7}
