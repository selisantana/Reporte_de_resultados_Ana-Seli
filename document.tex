...
\begin{document}
	...
	\section{Planteamiento del problema}
		...
		El problema de este proyecto se tratade la producción de bioetanol de segunda generación,
	...
	\begin{itemize}
		\item 
		Analizar experimentalmente las configuraciones de producción de bioetanol que incluyen el pretratamiento, la hidrolisis y fermenteción en etapa simultanea.
		\item  \sout{Análisis experimental de configuraciones de producción de bioetanol.}
		\item 	Diseñar e implementar un sistema de control de temperatura para las etapas de pretratamiento e hidolisis y fermentación en simultaneo, para la producción de bioetanol de segunda generación.
