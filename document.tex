...
Al realizarse las pruebas experimentales en el reactor tipo batch se registraron el consumo energético, a continuación en la Tabla \ref{tabla de energia} se presenta el costo que representa ese consumo energético.
