...
\begin{document}
	...
	Analizar experimentalmente los efectos del tamaño de partícula de biomasa, temperatura y tiempo de procesamiento para dos tipos de pretratamiento de bagazo de caña de azúcar, previos a la producción de bietanol de segunda generación mediante una hidrólisis y fermentación simultáneas, para producir bioetanol de segunda generación. \newline \newline
